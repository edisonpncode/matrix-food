...
export function CaixaContent() {
  ...
  // Fluxo multi-step do fechamento
  ...
  function handleFinishClose() {
    // Dispara impressão na impressora padrão se configurada.
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div className="rounded-xl border bg-green-50 p-4">
          ...
          {canViewTotals ? (
            ...
            <div
              className="flex h-7 items-center text-green-700/70"
        ...
        <div className="rounded-xl border bg-primary/10 p-4">
          ...
          {canViewTotals ? (
            ...
            <div
              className="flex h-8 items-center text-primary/70"
              title="Sem permissão para visualizar"
            >
      ...
      {/* Close Cash Register Modal — Step 1: Contagem cega */}
      {closeStep === "count" && (
      ...
      {/* Close Cash Register Modal — Step 2: Revisão com diferenças */}

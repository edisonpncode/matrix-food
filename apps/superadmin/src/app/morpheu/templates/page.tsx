...
export default function MorpheuTemplatesPage() {
  ...
  const [editing, setEditing] = useState<Record<
    string,
    { status: Status; metaTemplateId: string }
  >>({});
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Registre aqui o status atual de cada template no Meta Business Manager.
          O corpo precisa bater exatamente — crie no Meta com o mesmo nome técnico.
        </p>
      </div>
